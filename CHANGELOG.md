...
- Package the GEX/multiome and ATAC QC scripts as installable console commands.
...
- Add production repository metadata, security policy, license, Makefile, and Rust helper docs.
